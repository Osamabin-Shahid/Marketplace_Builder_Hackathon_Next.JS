...
//         <div className="space-y-6">
//           {cartItems.map((item) => (
//             <div key={item._id} className="flex justify-between items-center bg-white shadow-lg p-4 rounded-lg">
//               <div className="flex items-center space-x-4">
...
//       <div className="flex justify-between items-center mt-8 p-4 bg-gray-50 shadow-md rounded-lg">
//         <h2 className="text-2xl font-semibold">Total: Rs.{calculateTotal().toFixed(2)}</h2>
//         <button
//           onClick={handledProceed}
//           className="bg-blue-600 text-white py-2 px-6 rounded-lg hover:bg-transparent hover:text-blue-600 duration-300 shadow-lg transition"
//         >
//           Proceed to Checkout
//         </button>
//       </div>
